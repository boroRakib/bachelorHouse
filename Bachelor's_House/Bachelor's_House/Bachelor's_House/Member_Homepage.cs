...
namespace Bachelor_s_House
{
    public partial class Member_Homepage : Form
    {
        ...
        private void addMeal_Click(object sender, EventArgs e)
        {
            ...
            {
                BachelorDataContext b = new BachelorDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\LENOVO\Desktop\New folder\Bachelor's_House\Bachelor's_House\Bachelor.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            BachelorDataContext bdc = new BachelorDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\LENOVO\Desktop\New folder\Bachelor's_House\Bachelor's_House\Bachelor.mdf;Integrated Security=True;Connect Timeout=30");
